...
public class MasterBase
{
    ...
    private void SetField(string key, string value)
    {
		...
		else if (propertyInfo.PropertyType == typeof(CharacterAnimator))
				 propertyInfo.SetValue(this,(CharacterAnimator)Enum.Parse(typeof(CharacterAnimator),value),null);
		else if (propertyInfo.PropertyType == typeof(CharacterState))
				 propertyInfo.SetValue(this,(CharacterState)Enum.Parse(typeof(CharacterState),value),null);
